...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative w-full h-screen min-h-[700px] flex items-center justify-center overflow-hidden bg-[#FDFBF7] dark:bg-[#121212] transition-colors duration-300">
      ...
      >
        <span className="text-[10vw] md:text-[7vw] leading-[0.85] font-black uppercase tracking-tighter text-[#232021] dark:text-white transition-colors duration-300">CONTENT</span>
        <span className="text-[12vw] md:text-[9vw] leading-[0.85] font-black uppercase tracking-tighter text-[#232021] dark:text-white transition-colors duration-300">CREATOR</span>
      </motion.div>
      ...
      >
        <span className="text-[6.5vw] md:text-[4vw] leading-[0.85] font-black uppercase tracking-tighter text-[#232021] dark:text-white transition-colors duration-300">POWERED</span>
        <span className="text-[6.5vw] md:text-[4vw] leading-[0.85] font-black uppercase tracking-tighter text-[#232021] dark:text-white transition-colors duration-300">BY AI &amp;</span>
        <span className="text-[6.5vw] md:text-[4vw] leading-[0.85] font-black uppercase tracking-tighter text-[#232021] dark:text-white transition-colors duration-300">STRATEGY</span>
      </motion.div>
      ...
      <div className="absolute top-[15%] md:top-[45%] left-1/2 -translate-x-1/2 md:translate-x-0 md:left-12 z-20 flex flex-col md:flex-row gap-3 items-center md:items-start">
        ...
        >
          ...
          <span className="text-xs md:text-sm font-medium">Open for new opportunities</span>
        </motion.div>
        ...
        >
          <span className="text-xs md:text-sm font-medium">DE · ES · EN</span>
        </motion.div>
      </div>
      ...
      >
        <p className="text-xs md:text-sm font-medium leading-tight text-[#232021] dark:text-white/80 transition-colors duration-300">
          Video content and AI-powered workflows for brands that want to move faster.
        </p>
      </motion.div>
    </section>
  );
